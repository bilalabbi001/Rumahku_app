...
@section('content')
    ...
    <section class="py-5">
        <div class="p-4 max-w-2xl text-center mx-auto font-bold">
            <h1 class="text-md md:text-3xl">CLUSTER ACE</h1>
            <h3 class="text-xs mt-1 tracking-wide font-light md:text-md">
                KONSEP MODERN YANG DIRANCANG KHUSUS UNTUK ANDA
            </h3>
        </div>
        <div class="container -my-20 p-4 py-20 mx-auto grid grid-cols-1 md:grid-cols-3">
            <!-- Property Card 1 -->
                ...
                <div class="bg-white rounded-md overflow-hidden card-shadow">
                    ...
                    <div class="p-3">
                        ...
                        <div class="mt-6 pt-4 border-t border-gray-200">
                            <a href="{{ route('ace.show', $produk->slug) }}"
