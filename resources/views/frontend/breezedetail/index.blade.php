...
@section('content')
    ...
    <div class="max-w-7xl mx-auto p-2 md:p-8 grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <!-- Features -->
            <div class="bg-white rounded-2xl shadow p-2">
                <h2 class="text-sm md:text-lg font-bold mb-4">Fasilitas</h2>
                <div class="text-xs grid grid-cols-2 md:grid-cols-3 gap-2 text-gray-700 md:text-sm">
                    <p>✅ Madania Islamic School</p>
                    <p>✅ Marsudirini Catholic School</p>
                    <p>✅ Commercial Area</p>
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white rounded-2xl shadow p-6 text-center">
                <img src="{{ asset('assets/image/image1.jpg') }}" class="w-24 h-24 mx-auto rounded-full mb-2">
                <h3 class="text-xs md:text-lg font-semibold">Muhamad Bilal</h3>
                <p class="text-xs md:text-sm text-gray-500 mb-3">Real Estate Agent</p>
                <div class="text-xs md:text-sm space-y-1">
                    <p><i class="fa-solid fa-phone"></i> +62 857 7692 4860</p>
                    <p><i class="fa-solid fa-envelope"></i> Bilal.abbi27@gmail.com</p>
                    <p><i class="fa-solid fa-globe"></i> www.rumhaku.com</p>
                </div>
            </div>
    ...
    <div class=" max-w-7xl mx-auto bg-white rounded-xl shadow-sm p-2">
        ...
        <div class="rounded-lg overflow-hidden h-64 bg-gray-100 flex items-center justify-center">
            <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3281.4884842354604!2d106.70725165162443!3d-6.4796479799489815!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69dd000432b409%3A0x8417c6b64d10601e!2sCluster%20Aluna%20Sekar!5e0!3m2!1sid!2sid!4v1760412737791!5m2!1sid!2sid"
