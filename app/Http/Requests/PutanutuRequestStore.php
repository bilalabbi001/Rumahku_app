...
class PutanutuRequestStore extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'image1'        => 'required|image|mimes:png,jpg|max:2048',
            'image2'        => 'required|image|mimes:png,jpg|max:2048',
            'image3'        => 'required|image|mimes:png,jpg|max:2048',
            'image4'        => 'required|image|mimes:png,jpg|max:2048',
